# CSE15L LAB 3 REPORT (resubmission)
# RESEARCHING COMMANDS

I will be researching the find command for this report. The "find" command is 
used to search for files and directories within a specified directory hierarchy.
It traverses through directories recursively, allowing you to locate files based on various criteria such as name, size, modification time,
...
The command above is finding all files in "./technical"
